export const projects = [
    {
    name: "Multi-Agent AMD Hardware Debugger",
    description: [
  ...
  description: [
    "Research ML model predicting pediatric decompensation 12–15 hours early in collaboration with Children's Health Dallas and TCU Nursing.",
